...
class XStudio(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("opentimelineio/0.17.0")
    ...
    def generate(self):
        ...
        ct.variables["BUILD_TESTING"] = False
        ...
        print("HUIHUIHI", self.dependencies["opentimelineio"].cpp_info.components["opentime"].includedirs)
